...
with the sample "missing" model trained on data with random observational gaps totaling 10% of those 1001 samples. The 2D "normal" model was similarly trained with the additional information from 25 velocity channel bins. The 2D "transfer" 

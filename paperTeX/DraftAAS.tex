...
In all cases the models exhibit a systematic trend towards underepresenting the ground-truth delay values in both centroid and width, 
...
Note that while the labels on the axes are in units of days and km/s, really the both the delay and velocity axes are simply in units of array elements, 
...
by about 2 array elements in the delay dimension, while the mean offset of just $\sim$ -1 km/s in the velocity dimensions indiates that on average 
